...
const Signin: FC = () => {
  ...
  /** 跳过登录 */
  const handleSkip = () => {
    Taro.switchTab({ url: "/pages/tabs/home/index" });
  };
  ...
  return (
    <View className="w-full h-full mt-12 px-6">
      <View>
        ...
        <View
          className="w-full h-14 flex items-center gap-2 justify-center bg-blue-1 rounded-2xl"
          onClick={handleWechatLogin}
        >
          <AtIcon prefixClass="icon" value="029-chat" size={20} color="#ffffff" />
          <Text className="text-white text-base font-medium">微信一键登录</Text>
        </View>

        <View className="mt-8 flex justify-center items-center" onClick={handleSkip}>
